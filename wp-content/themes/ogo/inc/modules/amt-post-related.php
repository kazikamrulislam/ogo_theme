...
if( ! function_exists( 'ogo_related_post' )){
	
	function ogo_related_post(){
		...
		$related_post_number = OgoTheme::$options['show_related_post_number'];
		...
		if ( OgoTheme::$options['related_blog_auto_play'] == 1 ) {
			$auto_play = true;
		} else {
			$auto_play = false;
		}

		$speed = intval(OgoTheme::$options['related_blog_auto_play_speed']);
		$delay = intval(OgoTheme::$options['related_blog_auto_play_delay']);
		...
		<div class="amt-related-post">
			<div class="amt-swiper-slider-blog related-post" data-xld='<?php echo esc_attr( $swiper_data ); ?>'>
				<div class="section-title">
					<h3 class="related-title"><?php echo wp_kses( OgoTheme::$options['related_title'] , 'alltext_allow' ); ?>
					...
					?>
						<div class="blog-box swiper-slide">
							...
							<div class="entry-content">	
								...
								<span class="entry-categories style-1 mb-2"><?php echo ogo_category_prepare(); ?></span>
								<?php } ?>
							</div>
