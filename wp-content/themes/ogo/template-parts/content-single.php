...
<div id="post-<?php the_ID(); ?>" <?php post_class($post_layout_ops); ?>>
	...
	<?php if ( ( function_exists( 'get_post_format' ) && 'video' == get_post_format( $id ) && !empty( $youtube_link ) )  ) {		
		...
		<div class="entry-header">				
			<div class="d-flex align-items-center justify-content-between flex-wrap amt-single-post-meta">
				...
				<?php if ( OgoTheme::$options['post_date'] ) { ?>
							...
							<li><?php echo wp_kses( $ogo_comments_html , 'alltext_allow' ); ?></li>
							<?php } if ( OgoTheme::$options['post_length'] && function_exists( 'ogo_reading_time' ) ) { ?>
							<li class="meta-reading-time meta-item"><?php echo ogo_reading_time(); ?></li>
							<?php } if ( OgoTheme::$options['post_view'] && function_exists( 'ogo_views' ) ) { ?>
							<li><span class="meta-views meta-item "><?php echo ogo_views(); ?></span></li>
							<?php } if ( OgoTheme::$options['post_published'] && function_exists( 'ogo_get_time' ) ) { ?>	
							<li><?php echo ogo_get_time(); ?></li>
				...
				<?php if ( ( OgoTheme::$options['post_share'] ) && ( function_exists( 'ogo_post_share' ) ) ) { ?>
					<div class="post-share d-flex mb-3"><span class=" post-share-title me-3 mt-1"><?php esc_html_e( 'Share on:', 'ogo' );?></span><?php ogo_post_share(); ?></div>
				<?php } ?>
			</div>
		</div>
