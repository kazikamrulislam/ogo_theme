...
<div class="amt-header-menu mean-container" id="meanmenu">
    <?php if ( OgoTheme::$options['mobile_topbar'] ) { ?>
    ...
    <div class="mobile-mene-bar" id="mobile-men-bar">
        <div class="mean-bar">
            ...
            <div class="mobile-logo site-branding">
                <a class="dark-logo" href="<?php echo esc_url(home_url('/'));?>"><?php echo wp_kses( $ogo_dark_logo, 'alltext_allow' ); ?></a>
            </div> 
            <?php if ( OgoTheme::$options['mobile_search'] ) { ?>
