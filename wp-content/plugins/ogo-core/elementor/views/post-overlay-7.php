...
$ogo_has_entry_meta1  = ( $data['post_author'] == 'yes' || $data['post_comment'] == 'yes' || $data['post_length'] == 'yes' && function_exists( 'ogo_reading_time' ) || $data['post_view'] == 'yes' && function_exists( 'ogo_views' ) ) ? true : false;
...
$thumb_size1 = 'ogo-size3';
$thumb_size2 = 'ogo-size5';
								...
								<a href="<?php the_permalink(); ?>">
									<?php
										if ( has_post_thumbnail() ){
											...
											echo '<img class="wp-post-image" src="' . OgoTheme_Helper::get_asset_file( 'element/noimage_420X420.jpg' ) . '" alt="'.get_the_title().'">';
										}
									?>
								</a>
