...
<div class="amt-post-grid-default amt-post-grid-<?php echo esc_attr( $data['style'] );?>">
	<div class="blog-loadmore-style1">
	...
	<div class="text-center blog-loadmore">
		...
		<?php if ( $data['loadmore_display'] == 'yes' ) { ?>
	      	<a href="#" id="blog_loadMore_style1" class="loadMore" data-loadmore='<?php echo esc_attr( $encoded_data ) ;?>'><?php echo wp_kses_post( $data['button_text'] ); ?></a>
	      <?php } ?>
    </div> 
