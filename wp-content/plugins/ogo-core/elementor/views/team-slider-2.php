						...
						<div class="team-thums">
							<a href="<?php the_permalink();?>">
								...
								if ( has_post_thumbnail() ){
									...
									if ( !empty( OgoTheme::$options['no_preview_image']['id'] ) ) {
										echo wp_get_attachment_image( OgoTheme::$options['no_preview_image']['id'], $thumb_size );
									}
									else {
										echo '<img class="wp-post-image" src="' . OgoTheme_Helper::get_img( 'noimage_480X504.jpg' ) . '" alt="'.get_the_title().'">';
									}
								}
								?>
							</a>
