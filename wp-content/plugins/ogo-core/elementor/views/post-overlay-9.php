...
$thumb_size1 = 'ogo-size7';
$thumb_size2 = 'ogo-size6';
								...
								<a class="figure-overlay" href="<?php the_permalink(); ?>">
									<?php
										if ( has_post_thumbnail() ){
											...
											echo '<img class="wp-post-image" src="' . OgoTheme_Helper::get_asset_file( 'element/noimage_560X840.jpg' ) . '" alt="'.get_the_title().'">';
										}
									?>
								</a>										
							</div>
