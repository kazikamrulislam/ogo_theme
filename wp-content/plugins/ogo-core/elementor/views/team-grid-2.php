...
<div class="team-default team-multi-layout-2 team-grid-<?php echo esc_attr( $data['style'] );?>">
	<div class="team-loadmore-style2">
    ...
    $args['designation_display'] = $data['designation_display'];
    $args['ogo_team_position'] = $data['ogo_team_position'];
    $args['content_display'] = $data['content_display'];
    $args['content_display'] = $data['alltext_allow'];
    $args['ogo_team_socials'] = $data['ogo_team_socials'];
    $args['social_display'] = $data['social_display'];
	...
	<?php if ( $data['more_button'] == 'show' ) { ?>
		<?php if ( !empty( $data['see_button_text'] ) ) { ?>
			<a class="button-style-1" id="team_loadMore2" href="<?php echo esc_url( $data['see_button_link'] );?>" data-loadmore='<?php echo esc_attr($encoded_data); ?>'><?php echo esc_html( $data['see_button_text'] );?><i class="fas fa-arrow-right"></i></a></div>
		<?php } ?>
	<?php } else { ?>
