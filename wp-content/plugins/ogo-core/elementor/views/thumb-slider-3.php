...
<div class="amt-thumb-slider-default ogo-horizontal-slider amt-thumb-slider-<?php echo esc_attr( $data['slider_style'] );?> <?php echo esc_attr( $data['nav_style'] );?>">
