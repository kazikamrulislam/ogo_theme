...
<div class="team-default team-multi-layout-1 team-grid-<?php echo esc_attr( $data['style'] );?>">
	...
	<?php if ( $data['more_button'] == 'show' ) { ?>
		...
		<div class="team-button">
			<a class="button-style-1" id="team_loadMore1" href="<?php echo esc_url( $data['see_button_link'] );?>" data-loadmore='<?php echo esc_attr($encoded_data); ?>'><?php echo esc_html( $data['see_button_text'] );?><i class="fas fa-arrow-right"></i></a></div>
		<?php } ?>
	<?php } else { ?>
