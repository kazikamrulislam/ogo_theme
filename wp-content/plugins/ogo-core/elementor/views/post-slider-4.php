...
?>
<div class="amt-post-slider-default amt-swiper-slider-main3 amt-post-slider-<?php echo esc_attr( $data['style'] );?> <?php echo esc_attr( $data['nav_style'] );?>">
				...
				<div class="amt-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
					...
					<div class="entry-video">	
						<?php if ( ( $data['post_video'] == 'yes' && 'video' == get_post_format( $id ) && !empty( $youtube_link ) ) ) { ?>
							<div class="amt-video"><a class="amt-play play-btn-2 amt-video-popup" href="<?php echo esc_url( $youtube_link );?>"><i class="fas fa-play"></i></a></div>
						<?php } ?>
					</div>
				</div>				
			</div>
