...
.testi_btn_prev{
	...
	<div class="testimonial-item-1">
        <div class="testimonial-content-wrap <?php //echo esc_attr( $data['animation'] );?> <?php //echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php //echo esc_attr( $i );?>s" data-wow-duration="<?php //echo esc_attr( $j );?>s">
            <div class="testimonial-thums">
                ...
                <?php if ( !empty( $data['testimonial_statick_iamge']['id'] ) ) {
                    Group_Control_Image_Size::print_attachment_image_html( $data,'testimonial_statick_iamge' );
                    } else {
                    echo '<img class="wp-post-image" src="' . OgoTheme_Helper::get_element_img( 'amt-feedback-1-main.png' ) . '" alt="'.get_the_title().'">';
                } ?>
            </div>
            <div class="swiper ogoswiper4">
                        ...
                        <div class="testimonial-content">					
                            ...
                            <div class="author_detail">
                                ...
                                <div class="author_meta">
                                    ...
                                    <?php if ( $ogo_testimonial_author_avatar ) { ?>
                                        <div class="ratting"><?php //echo esc_html($ogo_testimonial_author_avatar);?></div>
                                    <?php } ?>
...
<script>
    jQuery( document ).ready(function() {
          var ogoswiper4 = new Swiper(".ogoswiper4", {';
