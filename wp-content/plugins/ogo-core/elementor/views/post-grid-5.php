...
$col_class = "col-md-{$data['col_md']} col-sm-{$data['col_sm']} col-{$data['col']}";

?>
<div class="amt-post-grid-default amt-post-grid-<?php echo esc_attr( $data['style'] );?>">
	<div class="blog-loadmore-style5">
	...
	<div class="text-center blog-loadmore">
		...
		<?php if ( $data['loadmore_display'] == 'yes' ) { ?>
	      	<a href="#" id="blog_loadMore_style5" class="loadMore" data-loadmore='<?php echo esc_attr( $encoded_data ) ;?>'><?php echo wp_kses_post( $data['button_text'] ); ?></a>
	      <?php } ?>
    </div>
