...
class Contact_Info extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->amt_name = esc_html__( 'AMT Contact Info', 'ogo-core' );
		$this->amt_base = 'amt-contact-info';
	...
	public function amt_fields(){
		$fields = array(
			...
			array(					 
			   ...
			   'options' => array(
			     'icon' => array(
			       'title' => esc_html__( 'Icon', 'ogo-core' ),
			       'icon' => 'fa fa-smile',
			     ),
			     'image' => array(
			       'title' => esc_html__( 'Image', 'ogo-core' ),
			       'icon' => 'fa fa-image',
			     ),		     
			   ),
			   'id'      => 'icontype',
			   'label'   => esc_html__( 'Media Type', 'ogo-core' ),
			   'default' => 'icon',
			   'label_block' => false,
			   'toggle' => false,
			),
			...
			array(
				...
				'default' => esc_html__( '29 Street, Melbourne City, Australia # 34 Road, House #10.', 'ogo-core' ),
			),
			array(
				'mode' => 'section_end',
			),			
			...
			array (
				...
				'name'    => 'info_typo',
				'label'   => esc_html__( 'Info Typo', 'ogo-core' ),
			...
			array(
				...
				'id'      => 'info_color',
				'label'   => esc_html__( 'Info Color', 'ogo-core' ),
				'default' => '',
				'selectors' => array(
