...
Class OgoTheme_Post_Tab extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname' => 'amt-post-tab',
			'description' => esc_html__( 'Post Tab Display Widget' , 'ogo-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'amt-post-tab', esc_html__( 'Ogo : Posts display Tab' , 'ogo-core' ), $widget_ops );
	}
	public function widget( $args, $instance ) {
		...
		<div class="post-tab-layout">
			<ul class="btn-tab nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a href="#recent-<?php esc_html_e( $tab_id ); ?>" data-bs-toggle="tab" aria-expanded="true" class="active"><?php esc_html_e('Recent', 'ogo-core'); ?></a>
				</li>
				<li class="nav-item">
					<a href="#popular-<?php esc_html_e( $tab_id ); ?>" data-bs-toggle="tab" aria-expanded="false"><?php esc_html_e( 'Popular', 'ogo-core'); ?></a>
				</li>
			</ul>
