...
class OgoTheme_Footer_About_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'ogo_footer_about_author', // Base ID
            esc_html__( 'Ogo : About (For Footer)', 'ogo-core' ), // Name
            array( 'description' => esc_html__( 'Footer About Widget', 'ogo-core' ) ) // Args
            );
	}
	...
	public function form( $instance ){
		...
		$fields = array(
			...
			'logo_image'    => array(
				'label'   => esc_html__( 'Logo', 'ogo-core' ),
				'type'    => 'image',
			),
			'description' => array(
