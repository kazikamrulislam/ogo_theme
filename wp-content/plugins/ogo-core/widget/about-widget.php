...
class OgoTheme_About_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'ogo_about_author', // Base ID
            esc_html__( 'Ogo : About Author', 'ogo-core' ), // Name
            array( 'description' => esc_html__( 'About Author Widget', 'ogo-core' ) ) // Args
            );
	}
	...
	public function widget( $args, $instance ){
		...
		$img   = wp_get_attachment_image( $instance['ab_image'], 'ogo-size5' );
	...
	public function form( $instance ){
		$defaults = array(
			'title'   		=> esc_html__( 'About Author' , 'ogo-core' ),
			'subtitle'		=> '',
			'text'			=> '',
			'ab_image'    	=> '',
			'bg_image'    	=> '',
		...
		$fields = array(
			...
			'ab_image'    => array(
				'label'   => esc_html__( 'Author', 'ogo-core' ),
				'type'    => 'image',
			),
			'bg_image'    => array(
				'label'   => esc_html__( 'background image', 'ogo-core' ),
				'type'    => 'image',
			),
			'subtitle' => array(
