...
if( !class_exists( 'AMT_Postmeta' ) ){
	...
	class AMT_Postmeta {
		...
		public function load_styles_and_scripts(){
			wp_enqueue_style( 'amt-posts-jqui', $this->base_url . 'assets/css/jquery-ui.css', array(), $this->version ); // only datepicker
			...
			wp_enqueue_style( 'amt-posts-style', $this->base_url . 'assets/css/style.css', array(), $this->version );
			...
			wp_enqueue_media();
			wp_enqueue_script('amt-posts-script', $this->base_url . 'assets/js/script.js', array('jquery', 'jquery-ui-core', 'wp-color-picker', 'jquery-ui-datepicker'), $this->version );
		}
